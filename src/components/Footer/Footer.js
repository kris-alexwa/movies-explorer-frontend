                    ...
                    <div className="footer__wrapper">
                        ...
                        <nav className="footer__nav">
                            <ul className="footer__list">
                                ...
                                <li className="footer__list-item">
                                    <a href="https://github.com/kris-alexwa" className="footer__link" target="_blank" rel="noreferrer">Github</a>
                                </li>
                                <li className="footer__list-item">
                                    <a href="https://vk.com/kris_sherlocked" className="footer__link" target="_blank" rel="noreferrer">ВКонтакте</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
